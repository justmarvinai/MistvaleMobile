...
| 3 | Tutorial overlay system | Dimmed screen + highlighted target + parchment dialogue from guide character ("the Wardenmaster"); step-driven from `tutorial_step_defs` |
