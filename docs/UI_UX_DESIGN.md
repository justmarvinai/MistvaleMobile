...
| 11 | Champion detail | Left: big idle stage w/ element ring, then **the four ladders**; right tabs: **Stats** (base+gear breakdown), **Gear** (9 slots visual), **Skills** (tome UI), **Masteries** (3 trees), **Lore** |
