...
| **FantasyUIs** — 99 UI components and 457 art files (dark-ember, deco-frames, line-glyphs, spell-icons) | [justmarvinai/FantasyUIs](https://github.com/justmarvinai/FantasyUIs) — the owner's own library, vendored by `pnpm fui:vendor` into `apps/client/src/fui/` and `public/fui/` | Owner's own work (all rights held); the underlying art packs are the CC0 and CC-BY sets that library credits | In use (design rework, 2026-08-18) |
